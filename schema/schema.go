...
const URL = "https://github.com/UnPoilTefal/perimeter/schema/memory.schema.json"

//go:embed perimeter.schema.json
var Perimeter []byte

// PerimeterURL est l'identifiant du schema de registre.
const PerimeterURL = "https://github.com/UnPoilTefal/perimeter/schema/perimeter.schema.json"
